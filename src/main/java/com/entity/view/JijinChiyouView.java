...
public class JijinChiyouView extends JijinChiyouEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 jijin
			...
			* 最新净值日期
			*/
			private String zuixinjingzhiriqi;
			/**
			* 最新净值日期的净值
			*/
	...
	public JijinChiyouView() {

	}

	public JijinChiyouView(JijinChiyouEntity jijinChiyouEntity) {
		try {
			BeanUtils.copyProperties(this, jijinChiyouEntity);
			...
			e.printStackTrace();
				...
				//级联表的get和set yonghu
					...
					*/
					...
					public String getZuixinjingzhiriqi() {
						return zuixinjingzhiriqi;
					}

					public void setZuixinjingzhiriqi(String zuixinjingzhiriqi) {
						this.zuixinjingzhiriqi = zuixinjingzhiriqi;
					}
