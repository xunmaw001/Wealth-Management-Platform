 ...
 */
@TableName("jijin_collection")
public class JijinCollectionView extends JijinCollectionEntity implements Serializable {
	...
	public JijinCollectionView() {

	}

	public JijinCollectionView(JijinCollectionEntity jijinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jijinCollectionEntity);
