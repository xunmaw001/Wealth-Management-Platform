    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in gonggaoList" v-bind:key="index" class="effect-bubba">
                            <img :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                            <figcaption>
                                <h2><span>{{item.gonggaoName}}</span></h2>
                                <p v-if="item.gonggaoNewMoney != null" >￥{{item.gonggaoNewMoney}}</p>
                                <a @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >View more</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in jijinTuijianList" v-bind:key="index" class="effect-bubba">
                            <img :src="item.jijinPhoto?item.jijinPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                            <figcaption>
                                <h2><span>{{item.jijinName}}</span></h2>
                                <p v-if="item.jijinNewMoney != null" >￥{{item.jijinNewMoney}}</p>
                                <a @click="jumpCheck('../jijin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >View more</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in jijinList" v-bind:key="index" class="effect-bubba">
                            <img :src="item.jijinPhoto?item.jijinPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                            <figcaption>
                                <h2><span>{{item.jijinName}}</span></h2>
                                <p v-if="item.jijinNewMoney != null" >￥{{item.jijinNewMoney}}</p>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`jijin/list`, 'get', {
            ...
            vue.jijinTuijianList = res.data.list;
        });
    });
</script>
