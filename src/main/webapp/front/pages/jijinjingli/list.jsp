                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jijinjingliName" id="jijinjingliName" placeholder="基金经理姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../jijinjingli/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.jijinjingliPhoto?item.jijinjingliPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../jijinjingli/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.jijinjingliName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.jijinjingliNewMoney"><span style="color: red;">{{item.jijinjingliNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#jijinjingliName').val() != null && jquery('#jijinjingliName').val() != "" && jquery('#jijinjingliName').val() != "null" ) {
                param['jijinjingliName'] = jquery('#jijinjingliName').val();
            }
                                                        

            // 获取列表数据
            http.request('jijinjingli/list', 'get', param, function(res) {
