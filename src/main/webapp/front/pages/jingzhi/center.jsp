    ...
    <ul class="layui-nav layui-nav-tree">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="jingzhiMoney" id="jingzhiMoney"  placeholder="净值" autocomplete="off" class="layui-input" style="width: 500px">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`jingzhi/session`, 'get', {}, function (data) {
                    // 表单赋值
