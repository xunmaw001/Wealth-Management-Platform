            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">持有份数</label>
                          <div class="layui-input-inline">
                              <input type="text" name="fenshuStart" id="fenshuStart"  lay-skin="integer"   placeholder="持有份数开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -5px">
                              <input type="text" name="fenshuEnd"   id="fenshuEnd"    lay-skin="integer|fenshuEnd"   placeholder="持有份数结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        form.verify({
            ...
            ,fenshuEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                    var fenshuStart = $("#fenshuStart").val();
                 if(fenshuStart != null && fenshuStart != "" && fenshuStart != "null"){
                    var number = parseInt(value)- parseInt(fenshuStart);
                    if(number<0){
                        return '持有份数的结束值不能小于开始值';
                    }
                 }
            }
        ...
        function pageList() {
            ...
            if (jquery('#fenshuStart').val() != null && jquery('#fenshuStart').val() != "" && jquery('#fenshuStart').val() != "null" ) {
                param['fenshuStart'] = jquery('#fenshuStart').val();
            }
            if (jquery('#fenshuEnd').val() != null && jquery('#fenshuEnd').val() != "" && jquery('#fenshuEnd').val() != "null" ) {
                param['fenshuEnd'] = jquery('#fenshuEnd').val();
            }
                                
            // 获取列表数据
            http.request('jijinChiyou/list', 'get', param, function(res) {
