...
<html>
	...
	<body style="background: #EEEEEE;">
		<div id="app">
			...
			<%--<div class="modal fade" id="tixianModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" style="z-index: 3000">
					<div class="modal-content">
						&lt;%&ndash; 模态框标题&ndash;%&gt;
						<div class="modal-header">
							<h5 class="modal-title" >提现模态框</h5>
						...
						<div class="modal-body">
							<input type="number" value="0" readonly name="zhanghu" id="zhanghu"  placeholder="账户名" lay-verify="required" autocomplete="off" class="layui-input" style="width: 500px">
						</div>
						&lt;%&ndash; 模态框按钮 &ndash;%&gt;
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
							<button type="button" @click="submitTixian" class="btn btn-theme">提现</button>
						</div>
					</div>
				</div>
			</div>--%>
				...
				<%--<div class="modal fade" id="tixianModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog" style="z-index: 3000">
						<div class="modal-content">
							...
							&lt;%&ndash; 模态框内容 &ndash;%&gt;
							<div class="modal-body">
								&lt;%&ndash;<input type="hidden" id="id">&ndash;%&gt;
								&lt;%&ndash;<textarea id="${entity?uncap_first?replace("Order","Commentback")}Content" style="width: 500px;height: 300px"></textarea>&ndash;%&gt;
							</div>
							&lt;%&ndash; 模态框按钮 &ndash;%&gt;
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
								&lt;%&ndash;<button type="button" @click="submit${entity?replace("Order","Commentback")}()" class="btn btn-theme">评价</button>&ndash;%&gt;
							</div>
						</div>
					</div>
				</div>--%>
				...
				<%--<el-dialog title="评论" :visible.sync="tixianModal" :modal-append-to-body="false">
					<el-form>
					...
					<div slot="footer" class="dialog-footer">
						<el-button @click="tixianModal = false">取 消</el-button>
						<el-button type="primary" @click="submitTixianModal()">确 定</el-button>
					</div>
				</el-dialog>--%>
			<!-- 轮播图 -->
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuName" id="yonghuName" lay-verify="required" placeholder="昵称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-block">
								...
								<div class="layui-input-block">
									<input type="text" value="0" readonly name="newMoney" id="newMoney"  placeholder="余额" autocomplete="off" class="layui-input" style="width: 300px">
									<div class="layui-form-mid layui-word-aux">
										<i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
										<a id="btn-recharge" href="javascript:void(0)">点我充值</a>
										<a id="btn-tixian" href="javascript:void(0)">点我提现</a>
		...
		<script>
            var vue = new Vue({
                ...
                methods: {
                    ...
                    tixian() {
						// $('#tixianModal').modal('show');//打开模态框;
                        this.tixianModal = true//打开模态框
                        debugger
					},
                    submitTixianModal() {
						<%--submit${entity?replace("Order","Commentback")}--%>
					}
                }
            });
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                // 充值
                jquery('#btn-tixian').click(function (e) {
                    layer.open({
                        type: 2,
                        title: '用户提现',
                        area: ['900px', '700px'],
                        content: '../recharge/tixian.jsp'
                    });
                });
                ...
                form.on('submit(thisSubmit)', function (data) {
                    let sexTypes = vue.detail.sexTypes;
                    debugger
                    data = data.field;
