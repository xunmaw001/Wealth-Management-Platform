...
<script>
    ...
    // 当前表的字典表
        ...
        function jiaoyijiluTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoyijilu_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('jiaoyijilu/list', 'get', param, function(res) {
