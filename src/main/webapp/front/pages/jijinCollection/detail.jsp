        ...
        <section class="blog-details-section pt-120 pb-120">
            <div class="data-detail-breadcrumb" style="width: 1110px; padding: 0px 10px; box-shadow: rgba(255, 0, 0, 0.3) 0px 0px 0px; margin: 20px auto; border-color: rgb(135, 206, 250); border-radius: 4px; border-width: 0px; border-style: solid; height: 54px;">
                <span class="layui-breadcrumb">
                    ...
                    <a><cite>{{detail.jijinCollectionName}}</cite></a>
                </span>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    <div><img :src="detail.jijinCollectionPhoto" alt="image" style="width: 80%;height: auto" ></div>
            ...
            <div class="col-lg-4" v-if="jijinCollectionRecommendList">
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="small-post-list">
                            <li class="small-post-single" v-for="(item,index) in jijinCollectionRecommendList" v-bind:key="index" @click="jump('../jijinCollection/detail.jsp?id='+item.id)">
                                <div class="thumb"><img width="65px" :src="item.jijinCollectionPhoto"  alt="image"></div>
                                <div class="content">
                                    <a class="main_color" class="date">{{item.jijinCollectionName}}</a>
                                    <h6 class="post-title"><a style="color: red">{{item.jijinCollectionNewMoney}}</a>RMB</h6>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    var vue = new Vue({
        ...
        data: {
            ...
            title: '',
            //系统推荐
            jijinCollectionRecommendList: [],
            // 当前详情页表
            detailTable: 'jijinCollection',
        },
        //  清除定时器
        destroyed: function () {
            // 不知道具体作用
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            // 详情信息
            vue.detail = res.data;
            vue.title = vue.detail.jijinCollectionName;
           // 轮播图片
            vue.swiperList = vue.detail.jijinCollectionPhoto ? vue.detail.jijinCollectionPhoto.split(",") : [];
            var swiperItemHtml = '';
        ...
        // 系统推荐
        http.request(`jijinCollection/list`, 'get', {
            page: 1,
            limit: 5,
            ...
            vue.jijinCollectionRecommendList = res.data.list;
        });
