            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">交易记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jijinId" name="jijinId" v-model="ruleForm.jijinId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiaoyijiluFenshu" name="jiaoyijiluFenshu" class="form-control"
                                               v-model="ruleForm.jiaoyijiluFenshu" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiaoyijiluSumMoney" name="jiaoyijiluSumMoney" class="form-control"
                                               v-model="ruleForm.jiaoyijiluSumMoney" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input style="width: 450px" id="jiaoyijiluValue" name="jiaoyijiluValue" class="form-control"
                                           v-model="ruleForm.jiaoyijiluValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiaoyijilu/info/" + id,
