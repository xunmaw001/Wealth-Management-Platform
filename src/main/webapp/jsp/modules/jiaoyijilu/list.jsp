...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">交易记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">交易记录列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //交易份数
            var jiaoyijiluFenshuCell = document.createElement('td');
            jiaoyijiluFenshuCell.innerHTML = item.jiaoyijiluFenshu;
            row.appendChild(jiaoyijiluFenshuCell);


            //总金额
            var jiaoyijiluSumMoneyCell = document.createElement('td');
            jiaoyijiluSumMoneyCell.innerHTML = item.jiaoyijiluSumMoney;
            row.appendChild(jiaoyijiluSumMoneyCell);


            //类型
            var jiaoyijiluTypesCell = document.createElement('td');
            jiaoyijiluTypesCell.innerHTML = item.jiaoyijiluValue;
            row.appendChild(jiaoyijiluTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiaoyijilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiaoyijilu", "addjiaoyijilu");
            window.location.href = "add-or-update.jsp"
        }
